...
<div class="container py-4 admin-page">
    <div class="admin-page-header mb-4">
        <div>
            <h1 class="admin-page-title">Thêm banner khuyến mãi</h1>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            value="{{ old('name') }}"
                            placeholder="Ví dụ: Banner lễ 30/4 - 1/5"
                            required
                        >
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            class="form-control rounded-4"
                            value="{{ old('headline') }}"
                            placeholder="Ví dụ: Flash Sale Mỹ Phẩm"
                            required
                        >
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        >
                        <small class="text-muted">Có thể để trống nếu đã chọn chương trình khuyến mãi ở trên.</small>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            placeholder="Để trống nếu muốn tự chuyển sang hotdeal theo promotion"
                        >
                    </div>
