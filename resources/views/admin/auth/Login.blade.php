...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white rounded shadow-md flex flex-col md:flex-row w-full max-w-4xl overflow-hidden">
        ...
        <div class="w-full md:w-1/2 p-8">
            <h2 class="text-2xl font-bold mb-6 text-center text-pink-600">ADMIN</h2>
            ...
            <div class="mt-4 text-center">
                <p class="text-sm">Chưa có tài khoản? <a href="{{ route('admin.register') }}" class="text-pink-500 hover:text-pink-600 font-semibold">Đăng ký</a></p>
            </div>
        </div>
    </div>
