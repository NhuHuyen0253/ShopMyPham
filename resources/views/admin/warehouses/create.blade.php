...
<div class="p-4 admin-page">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="admin-page-header mb-4">
            <div>
                <h1 class="admin-page-title">Tạo kho mới</h1>
            </div>

            <a href="{{ route('admin.warehouses.index') }}" class="btn-admin-light admin-header-btn">
            ...
            <div class="admin-card-body">
                <form method="POST" action="{{ route('admin.warehouses.store') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="location" name="location" type="text" class="admin-input" placeholder=" Ninh Kiều, Cần Thơ" value="{{ old('location') }}">
                    </div>
